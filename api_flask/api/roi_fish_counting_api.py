...
def cumulative_object_counting_x_axis_fig(input_video, detection_graph, category_index, is_color_recognition_enabled, roi, deviation, width_cms, width_pxs_x_cm):
    total_passed_fish = 0
...
def cumulative_object_counting_x_axis_sm(input_video, detection_model, category_index, is_color_recognition_enabled, roi, deviation, width_cms, width_pxs_x_cm):
    total_passed_fish = 0
