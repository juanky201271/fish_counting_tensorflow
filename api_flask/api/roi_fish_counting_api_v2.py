...
def cumulative_object_counting_x_axis_c(input_video, detection_model, category_index, is_color_recognition_enabled, roi, deviation, width_cms, width_pxs_x_cm):
    total_passed_fish = 0
